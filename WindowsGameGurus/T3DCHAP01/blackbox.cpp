...
LPDIRECTDRAW7         lpdd         = nullptr;   // dd object
LPDIRECTDRAWSURFACE7  lpddsprimary = nullptr;   // dd primary surface
LPDIRECTDRAWSURFACE7  lpddsback    = nullptr;   // dd back surface
LPDIRECTDRAWPALETTE   lpddpal      = nullptr;   // a pointer to the created dd palette
LPDIRECTDRAWCLIPPER   lpddclipper  = nullptr;   // dd clipper
...

{
    ...
    if ((lpdd->CreateClipper(0,&lpddclipper,nullptr))!=DD_OK)
       return(nullptr);
...
int DD_Fill_Surface(LPDIRECTDRAWSURFACE7 lpdds,int color)
{
    ...
    lpdds->Blt(nullptr,       // ptr to dest rectangle
               nullptr,       // ptr to source surface, NA            
               nullptr,       // ptr to source rectangle, NA
...
int Draw_Text_GDI(wchar_t *text, int x, int y, int color, LPDIRECTDRAWSURFACE7 lpdds)
{
    ...
    SetTextColor(xdc, 0);
    // Text shadow
    TextOutW(xdc, x + 2, y + 2, text, wcslen(text));

	// set the colors for the text up
	SetTextColor(xdc, color);
    // draw the text a
    TextOutW(xdc, x, y, text, wcslen(text));
