...
#define ARGB32(r, g, b, a) ((a) << 24) + ((r) << 16) + ((g) << 8) + b
...
// gdi functions
int Draw_Text_GDI(wchar_t *text, int x,int y,COLORREF color, LPDIRECTDRAWSURFACE7 lpdds = lpddsback);
int Draw_Text_GDI(wchar_t *text, int x,int y,int color, LPDIRECTDRAWSURFACE7 lpdds = lpddsback);
